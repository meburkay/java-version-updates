...
public class FindingMatching {
    ...
    public static void main(String[] args) {
        ...
        //findAny and findFirst difference became visible when doing async(parallel stream case) programming.
        ...
        //When we are using parallelStream or stream().parallel() the flow of the collections at the stream is different from sync/not parallel stream. And when we use that findAny result is changing according to stream flow.
