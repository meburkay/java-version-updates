...
public class BigDecimalDemo {
    public static void main(String[] args) {
        ...
        System.out.println(amount1-amount2);//0.30000000000001137 => The result is wrong at double. Because of that they create a BigDecimal Class. From now on we will use BigDecimal instead of double.
