...
public class TakeWhileDropWhile {
    ...
    //peek is used for debugging code. it follow the stream and write the results to the console.
    ...
    //takeWhile works like filter but if the list sorted it automatically stops the filter in the appropriate line according to condition.
    ...
    //drop while extract the elements that suitable to the condition.
